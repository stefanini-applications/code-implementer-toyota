...
import { MdArrowDropDown, MdKeyboardArrowRight, MdEdit } from 'react-icons/md';
...
export const ArrowSelect = styled(MdArrowDropDown)`
  position: absolute;
  right: 7px;
  pointer-events: none;
  font-size: 18px;
  color: ${props => props.theme.palette.GREYSCALE.DARK_THREE};
`;
